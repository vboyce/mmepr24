...
var SurveyJS = require('survey-knockout-ui');
...
var SurveyJS__namespace = /*#__PURE__*/_interopNamespaceDefault(SurveyJS);
...
class SurveyPlugin {
  ...
  trial(display_element, trial) {
    ...
    this.survey = new SurveyJS__namespace.Survey(trial.survey_json);
