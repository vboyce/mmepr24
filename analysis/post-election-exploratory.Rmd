...
# expectations |> filter(batch == BATCH) |> filter(candidate!="other") |>
#   ggplot() +
#   geom_histogram(aes(probability, fill=candidate), position="identity", bins=25,center = 0.5, alpha=0.5) +
#   scale_fill_manual(values=candidate_colors) +
#   THEME_POSTER
