...
scale_fill_response_types <- scale_fill_manual(
    values = c(
      "Harris" = "blue",
      "pronoun female" = "lightblue", 
      "Trump" = "red",
      "pronoun male" = "lightsalmon",
      "hedged" = "darkgray",
      "pronoun neutral" = "lightgray",
      "OTHER" = "lightgreen"
    ),
    breaks = c("Harris", "pronoun female", "Trump", "pronoun male", "hedged", "pronoun neutral", "OTHER")
  )
